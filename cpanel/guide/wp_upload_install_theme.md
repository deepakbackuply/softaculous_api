## Upload & install theme using Softaculous API Guide
This guide explains how to upload and install theme using Softaculous API.
...
| **POST** |
| insid  | 26_12345  | The installation ID for which you want to install the theme. |
...
| activate | 1 | This is to activate the theme upon installation <br> 0 – If you do not want to activate the theme <br> 1- If you want to activate the theme |
