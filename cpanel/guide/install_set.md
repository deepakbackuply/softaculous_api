...
| act  | manage_sets  | The value should be “manage_sets” to perform the action of install set. |
| softinstall_set  | SET-NAME | The value should be name of your set which is to be installed.  |
| softwebsites  | 26_12345 | The installation ID that you want the set to be installed on. |
