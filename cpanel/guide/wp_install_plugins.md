## Install WordPress plugins using Softaculous API Guide
This guide explains how to install WordPress plugins using Softaculous API.

### via cURL
```php

curl -d "insid=26_12345" -d "type=plugins" -d "slug=loginizer" -d "install=1" "https://user:password@domain.com:2083/frontend/jupiter/softaculous/index.live.php?act=wordpress&api=json"
