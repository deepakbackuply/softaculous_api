## Activate theme using Softaculous API Guide
This guide explains how to activate the theme using Softaculous API.

### via cURL
```php

curl -d "insid=26_12345" -d "type=themes" -d "slug=twentytwenty/style.css" -d "activate=1" "https://user:password@domain.com:2083/frontend/jupiter/softaculous/index.live.php?act=wordpress&api=json"
