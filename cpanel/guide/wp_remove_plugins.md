## Remove WordPress plugins using Softaculous API Guide
This guide explains how to remove WordPress plugins using Softaculous API.
...
| **POST** |
| insid  | 26_12345  | The installation ID for which you want to remove the plugin. |
