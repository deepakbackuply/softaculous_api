...
| themes   | 1   |		The value of plugin must be 1 to install theme in set |
...
| add_plugins_themes_data_names  | An array with the theme name  |	 An array with the theme names that you want to add |
