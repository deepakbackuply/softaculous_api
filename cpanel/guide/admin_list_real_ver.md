## List real version of the installations using Softaculous API Guide
This guide explains how to fetch real version of the installation using Softaculous API.
