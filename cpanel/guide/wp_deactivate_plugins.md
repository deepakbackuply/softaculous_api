## Deactivate WordPress plugins using Softaculous API Guide
This guide explains how to deactivate WordPress plugins using Softaculous API.

### via cURL
```php

curl -d "insid=26_12345" -d "type=plugins" -d "slug=akismet/akismet.php" -d "deactivate=1" "https://user:password@domain.com:2083/frontend/jupiter/softaculous/index.live.php?act=wordpress&api=json"
...
| **POST** |
| insid  | 26_12345  | The installation ID for which you want to deactivate the plugin. |
